...
<head>
    <title>部门管理</title>
    <jsp:include page="/common/backend_common.jsp"></jsp:include>
...
<script type="application/javascript">
    $(function () {
        ...
        var deptListTemplate=$("#deptListTemplate").html();//取出模板
...
//                        渲染
                        ...
                        showMessage("加载部门类别",result.msg,false);
                    }
                }
            })
        }
        ...
        function handleDeptSelected(deptId) {
            if(lastClickDeptId!=-1){
                var lastDept = $("#dept_"+lastClickDeptId+" .dd2-content:first");//取出上级部门
                lastDept.removeClass("btn-yellow");
                lastDept.removeClass("no-hover");
            }
            var currentDept = $("#dept_"+deptId+" .dd2-content:first");//取出当前部门
